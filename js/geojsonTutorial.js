...
var map = L.map('mapid').setView([39.82, -98.58], 5);
//Add base map from leaflet providers and add it to map .addTo(map);
...
//add a style to the line feature
var myStyle = {
    "color": "#ff7800",
    "weight": 5,
    "opacity": 0.65
};
//adding the line feature to the map
L.geoJSON(myLines, {
    style: myStyle
}).addTo(map);
...
//adding a style to marker point 
